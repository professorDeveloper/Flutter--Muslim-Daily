...
class _AudioScreenState extends State<AudioScreen> {
                        ...
                        Visibility(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(widget.list![currentIndex+1].englishName!,style: GoogleFonts.roboto(textStyle : TextStyle(color: Colors.black,
                                  fontSize: 20),fontWeight: FontWeight.bold)),   Text(widget.list![currentIndex+1].name!,style: GoogleFonts.roboto(textStyle : TextStyle(color: Colors.black,
                                  fontSize: 20),fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                        ...
                        Visibility(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(currentIndex>111 ? '' : widget.list![currentIndex+2].englishName!,     style: GoogleFonts.roboto(textStyle : TextStyle(color: Colors.black,
                                  fontSize: 20),fontWeight: FontWeight.bold)),   Text(currentIndex>111 ? '' : widget.list![currentIndex+2].name!,     style: GoogleFonts.roboto(textStyle : TextStyle(color: Colors.black,
                                  fontSize: 20),fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
  ...
  void _initAudioPlayer(String ind, Qari qari,) async {
    ...
    try {
      var url = "https://server${qari.serverNumber}.mp3quran.net/${qari.identifier}/${ind}.mp3";
      print(ind.toString()+"Oyat number !");
      print('url $url');
